          ...
          <div class="contacts_block">
            ...
            <div class="contacts_list">
              <div class="contact_wrapper">
                <a class="link-dormitory_contact" href="https://www.google.com/maps/search/?api=1&query={{ dormitory.address }}">
                  <img src="../assets/location.icon.svg" alt="Location" />
                  <p>{{ dormitory.address }}}</p>
                </a>
              </div>
              <div class="contact_wrapper">
                <a class="link-dormitory_contact" href="tel: {{ dormitory.phone }}">
